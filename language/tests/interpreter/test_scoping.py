...
def test_global_access_from_nested_scopes(capsys):
    ...
    function test_global_access() {
        function deeply_nested() {
            function even_deeper() {
